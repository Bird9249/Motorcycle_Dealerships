import type { UsersListResult } from "@/server/modules/users/types";
import { usePermissions } from "@/web/features/auth/model/usePermissions";
import { config } from "@/web/shared/lib/config";
import { getInitials } from "@/web/shared/lib/utils";
import { RowActions } from "@/web/shared/ui/RowActions";
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
