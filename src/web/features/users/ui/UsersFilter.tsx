import type {
  FilterConditionDTO,
  OffsetPageQueryDTO,
} from "@/server/shared/contracts/base";
import {
  findCondition,
  removeConditions,
  upsertCondition,
  upsertOrGroup,
} from "@/server/shared/contracts/query-helpers";
...
import { InfiniteCombobox } from "@/web/shared/ui/InfiniteCombobox";
import { SimpleSelect } from "@/web/shared/ui/SimpleSelect";
import {
  Button,
  Input,
  Tabs,
